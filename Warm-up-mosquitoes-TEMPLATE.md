...
West Nile Virus is a common virus in the USA that is spread by the
...
To begin this experiment, we first collected mosquitoes from multiple
traps placed in various locations. We then collected the blood meal from
the mosquitoes to use to perform a standard PCR test to amplify the DNA
present in the blood meal of each mosquito. We sequenced the DNA samples
and used the BLASTn software to identify the species the blood meal came
...
Based on the data we collected, our results indicate that house finches
play an important role in the spread of WNV in Salt Lake City. This
evidence supports our hypothesis that house finches play an amplifying
role in the spread of WNV, and that the presence of house finches
